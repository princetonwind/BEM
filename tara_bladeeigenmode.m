function [ omegas, uyev, uzev,thetaz, mbendy, mbendz ] = tara_bladeeigenmode( radius,  twist, eixx, eiyy, mass, pitch, p_y, p_z)
...
% Flexibility matrix, y loading
    for j = 2:ni 
        ...
        py(j) = 1.0;
        pz(j) = 0.0;
    [uy,~,mbendy,uz,thetaz,mbendz]=tara_deflec2(radius,eixx,eiyy,twist,pitch,py,pz, p_y, p_z);
       py(j)=0.0;
       pz(j)=0.0; 
